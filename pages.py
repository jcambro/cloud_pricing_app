...
class StartPage(Frame):
	def __init__(self, parent, controller):
		...
		label = Label(self, text="Welcome to Cloud Cost Comparison", bg=backg, fg=foreg, font=major_font).grid(row=0, padx=10, pady=15)
		...
		storage_page = Button(self, text="Explore Storage Pricing", font=my_font, height=2, width=25, bg=button_backg, fg=foreg, activebackground=active_bg, activeforeground=active_fg, command= lambda: controller.show_frame(StoragePage) ).grid(row=2, padx=10, pady=5)
		compute_page = Button(self, text="Explore Computing Pricing",font=my_font, height=2, width=25, bg=button_backg, fg=foreg, activebackground=active_bg, activeforeground=active_fg, command= lambda: controller.show_frame(ComputingPage) ).grid(row=3, padx=10, pady=5)
